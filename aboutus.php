...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-9">
      <h2>What is TRVL?</h2>
      <h4>TRVL is an online bus ticket booking platform. At its initial stage, TRVL is designed and optimised for use in PDPM IIITDM Jabalpur, Madhya Pradesh, India.</h4>
      <h4>TRVL aims to make the long wait in queues obsolete. Tickets of all buses at all the time slots are
		  made available for a comfortable booking experience, from anywhere. TRVL provides the users the choice and comfort to plan their travel and evening get-outs from the comfort of their hostels and houses.</h4>
	   <h4>The buses are not owned or operated by TRVL. The tickets for the same are available on TRVL and are also available with the respective bus contractors.</h4>
    </div>
    <div class="col-sm-3">
      <center>
...
<div class="container-fluid bg-grey">
  <div class="row">
    ...
    <div class="col-sm-8">
      ...
      <h4>TRVL was conceived as a part of the end semester project for Course CS201 - Database Management Systems. The primary motivation however was to get rid of the hassle of engaging in queues for booking bus tickets for self and sometimes for seniors. </h4>
    </div>
  </div>
</div>
