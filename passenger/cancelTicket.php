...
<body>
	...
	if(isset($_GET['alert']))
	{
		echo '<div class = container><div class="alert alert-success">
		  <strong>Yay! Your ticket is cancelled!...</strong> Remember, you can always TRVL :)
		</div></div>';
	}?>
  ...
  <div class="container">
    ...
    <table class="table table-hover">
          ...
          <?php
            ...
            $userType=$row['Type'];
            $sql1 = "SELECT * FROM trvl.seat_matrix JOIN trvl.routes ON trvl.seat_matrix.RID = trvl.routes.RID WHERE Passenger = '$userID' ORDER BY BusDate DESC;";
